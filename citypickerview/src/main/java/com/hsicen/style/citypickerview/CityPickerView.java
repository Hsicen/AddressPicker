package com.hsicen.style.citypickerview;
...
import com.hsicen.citywheel.CityConfig;
import com.hsicen.citywheel.CityParseHelper;
import com.hsicen.style.citylist.Toast.ToastUtils;
import com.hsicen.style.citypickerview.widget.CanShow;
import com.hsicen.style.citypickerview.widget.wheel.OnWheelChangedListener;
import com.hsicen.style.citypickerview.widget.wheel.WheelView;
import com.hsicen.style.citypickerview.widget.wheel.adapters.ArrayWheelAdapter;
import com.hsicen.utils.utils;
            ...
            public void onClick(View v) {
                if (parseHelper != null) {
                    if (config.getWheelType() == CityConfig.WheelType.PRO) {
                        ...
                        mBaseListener.onSelected(
                                parseHelper.getProvinceBean(),
